...
The workflow for this is in [asw2122.yml](https://github.com/Arquisoft/dede_0/blob/master/.github/workflows/asw2122.yml). In this file you can see that there are two jobs, one for the restapi, one for the webapp. Jobs are executed in pararel so this will speed up our build.
